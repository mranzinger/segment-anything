...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        if self.use_rel_pos:
            ...
            # sq_input_size = input_size[0] * input_size[1]
            # q_coords = torch.arange(sq_input_size)[:, None] * max(self.input_size / self.input_size, 1.0)
            # k_coords = torch.arange(sq_input_size)[None, :] * max(self.input_size / self.input_size, 1.0)
